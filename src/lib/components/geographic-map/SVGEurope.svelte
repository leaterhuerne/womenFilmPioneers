<script lang="ts">
    ...
    export let countries = {
        ...
        UK: {key: "UK", id: "unitedKingdom", color: "#00008b", de: "Großbritannien", en: "United Kingdom"},
        FR: {key: "FR", id: "france", color: "#00008b", de: "Frankreich", en: "France"},
        IT: {key: "IT", id: "italy", color: "#00008b", de: "Italien", en: "Italy"},
        ES: {key: "ES", id: "spain", color: "#00008b", de: "Spanien", en: "Spain"},
        UA: {key: "UA", id: "ukraine", color: "#00008b", de: "Ukraine", en: "Ukraine"},
        PL: {key: "PL", id: "poland", color: "#00008b", de: "Polen", en: "Poland"},
        RO: {key: "RO", id: "romania", color: "#00008b", de: "Rumänien", en: "Romania"},
        NL: {key: "NL", id: "netherlands", color: "#00008b", de: "Niederlande", en: "Netherlands"},
        BE: {key: "BE", id: "belgium", color: "#00008b", de: "Belgien", en: "Belgium"},
        CZ: {key: "CZ", id: "czechia", color: "#00008b", de: "Tschechien", en: "Czechia"},
        EL: {key: "EL", id: "greece", color: "#00008b", de: "Griechenland", en: "Greece"},
        PT: {key: "PT", id: "portugal", color: "#00008b", de: "Portugal", en: "Portugal"},
        SE: {key: "SE", id: "sweden", color: "#00008b", de: "Schweden", en: "Sweden"},
        HU: {key: "HU", id: "hungary", color: "#00008b", de: "Ungarn", en: "Hungary"},
        BY: {key: "BY", id: "belarus", color: "#00008b", de: "Belarus", en: "Belarus"},
        AT: {key: "AT", id: "austria", color: "#00008b", de: "Österreich", en: "Austria"},
        CH: {key: "CH", id: "switzerland", color: "#00008b", de: "Schweiz", en: "Switzerland"},
        BG: {key: "BG", id: "bulgaria", color: "#00008b", de: "Bulgarien", en: "Bulgaria"},
        DK: {key: "DK", id: "denmark", color: "#00008b", de: "Dänemark", en: "Denmark"},
        FI: {key: "FI", id: "finland", color: "#00008b", de: "Finland", en: "Finland"},
        SK: {key: "SK", id: "slovakia", color: "#00008b", de: "Slowakei", en: "Slovakia"},
        NO: {key: "NO", id: "norway", color: "#00008b", de: "Norwegen", en: "Norway"},
        IE: {key: "IE", id: "ireland", color: "#00008b", de: "Irland", en: "Ireland"},
        HR: {key: "HR", id: "croatia", color: "#00008b", de: "Kroatien", en: "Croatia"},
        MD: {key: "MD", id: "moldova", color: "#00008b", de: "Moldawien", en: "Moldova"},
        BA: {key: "BA", id: "bosniaAndHerzegovina", color: "#00008b", de: "Bosnien und Herzegowina", en: "Bosnia and Herzegovina"},
        AL: {key: "AL", id: "albania", color: "#00008b", de: "Albanien", en: "Albania"},
        LT: {key: "LT", id: "lithuania", color: "#00008b", de: "Litauen", en: "Lithuania"},
        MK: {key: "MK", id: "northMacedonia", color: "#00008b", de: "Nordmazedonien", en: "North Macedonia"},
        SI: {key: "SI", id: "slovenia", color: "#00008b", de: "Slowenien", en: "Slovenia"},
        ...
        TR: {key: "TR", id: "turkey", color: "#00008b", de: "Türkei", en: "Turkey"}
    }
    ...
    export let svgPathStyling: string = "hover:brightness-125 cursor-pointer";
    export let listeners: {                     // listener to make each country reactive for mouse action
...
<svg
     ...
     width="100%" height="100%" viewBox="0 0 1110.000000 1280.000000"
...
-50 -13 0 -36 48 -36 76 0 23 9 16 30 -26z"
              fill={countries.NO.color} stroke="none"
              on:click={() => listeners.onClick(countries.NO)}
              on:mouseover={() => listeners.onMouseOver(countries.NO)}
              on:mouseout={() => listeners.onMouseOut(countries.NO)} />
        <path class="{svgPathStyling}"
...
134 53 198 -109 332 -53 44 -101 79 -107 79 -6 -1 -54 -26 -106 -55z"
              fill={countries.FI.color} stroke="none"
              on:click={() => listeners.onClick(countries.FI)}
              on:mouseover={() => listeners.onMouseOver(countries.FI)}
              on:mouseout={() => listeners.onMouseOut(countries.FI)}/>
        <path class="{svgPathStyling}"
...
98 -112 195 -288 323 -145 105 -198 148 -251 204 -47 49 -62 57 -75 37z"
              fill={countries.SE.color}
              on:click={() => listeners.onClick(countries.SE)}
              on:mouseover={() => listeners.onMouseOver(countries.SE)}
              on:mouseout={() => listeners.onMouseOut(countries.SE)}/>
        <path class="{svgPathStyling}"
...
-123 35 -174 41 -206 24z"
              fill={countries.EE.color}
              on:click={() => listeners.onClick(countries.EE)}
              on:mouseover={() => listeners.onMouseOver(countries.EE)}
              on:mouseout={() => listeners.onMouseOut(countries.EE)}/>
        <path class="{svgPathStyling}"
...
96 123 89 84 92 88 75 105 -15 16 -41 18 -186 21 l-169 3 -20 -53z"
              fill={countries.UK.color}
              on:click={() => listeners.onClick(countries.UK)}
              on:mouseover={() => listeners.onMouseOver(countries.UK)}
              on:mouseout={() => listeners.onMouseOut(countries.UK)}/>
        <path class="{svgPathStyling}"
...
-155 86 -52 53 -117 94 -150 93 -8 0 -37 -9 -64 -19z"
              fill={countries.LV.color}
              on:click={() => listeners.onClick(countries.LV)}
              on:mouseover={() => listeners.onMouseOver(countries.LV)}
              on:mouseout={() => listeners.onMouseOut(countries.LV)}/>
        <path class="{svgPathStyling}"
...
-81 122 0 36 9 97 20 136 23 83 25 119 8 136 -15 15 -17 15 -53 -4z"
              fill={countries.DK.color}
              on:click={() => listeners.onClick(countries.DK)}
              on:mouseover={() => listeners.onMouseOver(countries.DK)}
              on:mouseout={() => listeners.onMouseOut(countries.DK)}/>
        <path class="{svgPathStyling}"
...
85 -154 181 -208 181 -15 0 -40 15 -64 40 -22 22 -43 40 -47 39 -3 0 -18 -9 -33 -21z"
              fill={countries.LT.color}
              on:click={() => listeners.onClick(countries.LT)}
              on:mouseover={() => listeners.onMouseOver(countries.LT)}
              on:mouseout={() => listeners.onMouseOut(countries.LT)}/>
        <path class="{svgPathStyling}"
...
-40 14 -19 -5 -30 -2 -39 11 -12 16 -17 13 -66 -33z"
              fill={countries.BY.color}
              on:click={() => listeners.onClick(countries.BY)}
              on:mouseover={() => listeners.onMouseOver(countries.BY)}
              on:mouseout={() => listeners.onMouseOut(countries.BY)}/>
        <path class="{svgPathStyling}"
...
111 47 151 127 45 93 35 99 -82 40z"
              fill={countries.IE.color}
              on:click={() => listeners.onClick(countries.IE)}
              on:mouseover={() => listeners.onMouseOver(countries.IE)}
              on:mouseout={() => listeners.onMouseOut(countries.IE)}/>
        <path class="{svgPathStyling}"
              d="M6299 5708 c-47 -49 -46 -54 11 -49 14 1 31 9 38 18 13 18 17 70 5
75 -5 2 -29 -18 -54 -44z" fill={countries.LT.color}
              on:click={() => listeners.onClick(countries.LT)}
              on:mouseover={() => listeners.onMouseOver(countries.LT)}
              on:mouseout={() => listeners.onMouseOut(countries.LT)}/>
        <path class="{svgPathStyling}"
              d="M5060 5735 c0 -19 36 -55 55 -55 20 0 19 12 -6 44 -22 29 -49 35 -49
11z" fill={countries.DK.color}
              on:click={() => listeners.onClick(countries.DK)}
              on:mouseover={() => listeners.onMouseOver(countries.DK)}
              on:mouseout={() => listeners.onMouseOut(countries.DK)}/>
        <path class="{svgPathStyling}"
...
34 49 39 5 73 -126 96 -35 6 -75 14 -89 17 l-24 6 18 -29z"
              fill={countries.DE.color}
              on:click={() => listeners.onClick(countries.DE)}
              on:mouseover={() => listeners.onMouseOver(countries.DE)}
              on:mouseout={() => listeners.onMouseOut(countries.DE)}/>
        <path class="{svgPathStyling}"
...
-65 92 -212 49z"
              fill={countries.PL.color}
              on:click={() => listeners.onClick(countries.PL)}
              on:mouseover={() => listeners.onMouseOver(countries.PL)}
              on:mouseout={() => listeners.onMouseOut(countries.PL)}/>
        <path class="{svgPathStyling}"
...
-48 78 -96 91 -45 12 -123 13 -174 1z"
              fill={countries.NL.color}
              on:click={() => listeners.onClick(countries.NL)}
              on:mouseover={() => listeners.onMouseOver(countries.NL)}
              on:mouseout={() => listeners.onMouseOut(countries.NL)}/>
        <path class="{svgPathStyling}"
...
-32 40 -123 79 -158 67z"
              fill={countries.UA.color}
              on:click={() => listeners.onClick(countries.UA)}
              on:mouseover={() => listeners.onMouseOver(countries.UA)}
              on:mouseout={() => listeners.onMouseOut(countries.UA)}/>
        <path class="{svgPathStyling}"
...
-18 21 -22 21 -126 -20z"
              fill={countries.BE.color}
              on:click={() => listeners.onClick(countries.BE)}
              on:mouseover={() => listeners.onMouseOver(countries.BE)}
              on:mouseout={() => listeners.onMouseOut(countries.BE)}/>
        <path class="{svgPathStyling}"
...
-16 42 c-14 36 -20 41 -47 41 -17 -1 -48 -9 -70 -20z"
              fill={countries.FR.color}
              on:click={() => listeners.onClick(countries.FR)}
              on:mouseover={() => listeners.onMouseOver(countries.FR)}
              on:mouseout={() => listeners.onMouseOut(countries.FR)}/>
        <path class="{svgPathStyling}"
...
-60 19 -67 37 -7 19 -16 22 -56 21 -27 0 -77 -8 -113 -18z"
              fill={countries.CZ.color}
              on:click={() => listeners.onClick(countries.CZ)}
              on:mouseover={() => listeners.onMouseOver(countries.CZ)}
              on:mouseout={() => listeners.onMouseOut(countries.CZ)}/>
        <path class="{svgPathStyling}"
              d="M3286 4053 c-18 -46 1 -139 30 -150 22 -8 54 31 54 66 0 55 -69 124 -84 84z"
              fill={countries.LU.color}
              on:click={() => listeners.onClick(countries.LU)}
              on:mouseover={() => listeners.onMouseOver(countries.LU)}
              on:mouseout={() => listeners.onMouseOut(countries.LU)}/>
        <path class="{svgPathStyling}"
...
-50 -27z"
              fill={countries.SK.color}
              on:click={() => listeners.onClick(countries.SK)}
              on:mouseover={() => listeners.onMouseOver(countries.SK)}
              on:mouseout={() => listeners.onMouseOut(countries.SK)}/>
        <path class="{svgPathStyling}"
...
27 -92 32 -122 28 -186 -25z"
              fill={countries.AT.color}
              on:click={() => listeners.onClick(countries.AT)}
              on:mouseover={() => listeners.onMouseOver(countries.AT)}
              on:mouseout={() => listeners.onMouseOut(countries.AT)}/>
        <path class="{svgPathStyling}"
...
-167 21z"
              fill={countries.HU.color}
              on:click={() => listeners.onClick(countries.HU)}
              on:mouseover={() => listeners.onMouseOver(countries.HU)}
              on:mouseout={() => listeners.onMouseOut(countries.HU)}/>
        <path class="{svgPathStyling}"
...
-61 12 -120 -1z" fill={countries.MD.color}
              on:click={() => listeners.onClick(countries.MD)}
              on:mouseover={() => listeners.onMouseOver(countries.MD)}
              on:mouseout={() => listeners.onMouseOut(countries.MD)}/>
        <path class="{svgPathStyling}"
...
-9 86 -21 175 -26 197 -22 80 -164 331 -220 388 -31 30 -64 34 -94 11z"
              fill={countries.RO.color}
              on:click={() => listeners.onClick(countries.RO)}
              on:mouseover={() => listeners.onMouseOver(countries.RO)}
              on:mouseout={() => listeners.onMouseOut(countries.RO)}/>
        <path class="{svgPathStyling}"
...
89 -56 136 0 13 -5 32 -10 43 -12 21 -57 23 -185 8z"
              fill={countries.CH.color}
              on:click={() => listeners.onClick(countries.CH)}
              on:mouseover={() => listeners.onMouseOver(countries.CH)}
              on:mouseout={() => listeners.onMouseOut(countries.CH)}/>
        <path class="{svgPathStyling}"
...
-82 55 -65 19 -83 29 -146 74 -30 21 -109 30 -156 18z"
              fill={countries.IT.color}
              on:click={() => listeners.onClick(countries.IT)}
              on:mouseover={() => listeners.onMouseOver(countries.IT)}
              on:mouseout={() => listeners.onMouseOut(countries.IT)}/>
        <path class="{svgPathStyling}"
...
20 10 37 24 38 31 0 6 1 27 2 46 2 30 10 41 60 79 122 93 95 127 -62 77z"
              fill={countries.SI.color}
              on:click={() => listeners.onClick(countries.SI)}
              on:mouseover={() => listeners.onMouseOver(countries.SI)}
              on:mouseout={() => listeners.onMouseOut(countries.SI)}/>
        <path class="{svgPathStyling}"
...
-46 -134 -12 -307 85 -130 72 -168 83 -217 61z"
              fill={countries.HR.color}
              on:click={() => listeners.onClick(countries.HR)}
              on:mouseover={() => listeners.onMouseOver(countries.HR)}
              on:mouseout={() => listeners.onMouseOut(countries.HR)}/>
        <path class="{svgPathStyling}"
...
-15 -6 -16 -13 -30 -15 -30 -3 0 -18 16 -35 35 -30 34 -48 42 -62 28z"
              fill={countries.BA.color}
              on:click={() => listeners.onClick(countries.BA)}
              on:mouseover={() => listeners.onMouseOver(countries.BA)}
              on:mouseout={() => listeners.onMouseOut(countries.BA)}/>
        <path class="{svgPathStyling}"
...
-55 -9z"
              fill={countries.BG.color}
              on:click={() => listeners.onClick(countries.BG)}
              on:mouseover={() => listeners.onMouseOver(countries.BG)}
              on:mouseout={() => listeners.onMouseOut(countries.BG)}/>
        <path class="{svgPathStyling}"
...
-108 0 -134 3 -172 20 -56 26 -101 27 -147 3z"
              fill={countries.ES.color}
              on:click={() => listeners.onClick(countries.ES)}
              on:mouseover={() => listeners.onMouseOver(countries.ES)}
              on:mouseout={() => listeners.onMouseOut(countries.ES)}/>
        <path class="{svgPathStyling}"
...
-42 79 -43 84 -43 177 0 70 -5 105 -17 127 -35 65 -111 110 -159 93z"
              fill={countries.AL.color}
              on:click={() => listeners.onClick(countries.AL)}
              on:mouseover={() => listeners.onMouseOver(countries.AL)}
              on:mouseout={() => listeners.onMouseOut(countries.AL)}/>
        <path class="{svgPathStyling}"
...
39 92 15 124 94 73 183 -33 60 -75 79 -177 84 -81 4 -89 3 -108 -19z"
              fill={countries.MK.color}
              on:click={() => listeners.onClick(countries.MK)}
              on:mouseover={() => listeners.onMouseOver(countries.MK)}
              on:mouseout={() => listeners.onMouseOut(countries.MK)}/>
        <path class="{svgPathStyling}"
...
-22 27 -40 32 -79 22z"
              fill={countries.PT.color}
              on:click={() => listeners.onClick(countries.PT)}
              on:mouseover={() => listeners.onMouseOver(countries.PT)}
              on:mouseout={() => listeners.onMouseOut(countries.PT)}/>
        <path class="{svgPathStyling}"
...
5z"
              fill={countries.TR.color}
              on:click={() => listeners.onClick(countries.TR)}
              on:mouseover={() => listeners.onMouseOver(countries.TR)}
              on:mouseout={() => listeners.onMouseOut(countries.TR)}/>
        <path class="{svgPathStyling}"
...
-126 18 -172 32 -96 28 -127 30 -191 9z"
              fill={countries.EL.color}
              on:click={() => listeners.onClick(countries.EL)}
              on:mouseover={() => listeners.onMouseOver(countries.EL)}
              on:mouseout={() => listeners.onMouseOut(countries.EL)}/>
        <path class="{svgPathStyling}"
