 ...
 */
export const getData = (professionList?: boolean, locationList?: boolean, year?: string | number,
 ...
 */
export const getProfessionList = (consumer: Consumer<JSON>): void => {
 ...
 */
export  const getLocationList = (consumer: Consumer<JSON>): void => {
 ...
 */
export const get = (location: string, profession: string, consumer: Consumer<JSON>): void => {
 ...
 */
export const getAllDefault = (consumer: Consumer<JSON>): void => {
    fetch(domainString + "/api/genders-by-year").then(response => response.json()).then(consumer);
}