...
<div class="${escape(className, true) + " flex flex-col w-full"}">
    ...
    <div class="relative p-2 grid grid-cols-1 min-h-[24rem] select-none"><div class="absolute lg:relative h-64 w-full flex justify-center">
...
<div class="relative flex flex-col lg:flex-row 3xl:flex-col 2xl:gap-4 grow ">
    <div class="flex flex-col lg:w-2/3 3xl:w-full">
      ...
      $$result,
      {
        de: "Anpassung der Daten auf der Zeitwalze",
        en: "Customization of data on the time roll"
      },
      {},
      {}
    )}</h1>
...
//# sourceMappingURL=_page.svelte-8d675485.js.map
