...
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="z-50 flex justify-between gap-4 place-items-center w-full p-2 text-center text-paper-200 dark:text-dark-paper-200 bg-firebrick-500 dark:bg-firebrick-1000 "><a href="/" class="italic font-semibold ">${validate_component(T, "T").$$render(
    $$result,
    {
    ...
    <div class="grow flex justify-end gap-3 place-items-center font-semibold"><a href="/roll" class="hover:underline">${validate_component(T, "T").$$render($$result, { de: "Walze", en: "Roll" }, {}, {})}</a>
...
//# sourceMappingURL=_layout.svelte-26ffe3a8.js.map
