import { c as create_ssr_component, b as subscribe, v as validate_component, e as escape, f as add_attribute, d as each } from './index-64ea2edd.js';
import { l as language } from './language-c6711ffc.js';
import { C as ColorPicker, a as CheveronRight, b as CheveronLeft } from './CheveronLeft-586d2765.js';
...
const PathInteractive = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `&gt;
    <path${add_attribute("class", className, 0)}${add_attribute("d", d, 0)}${add_attribute("fill", countryData.color, 0)}${add_attribute("stroke", stroke, 0)}></path>`;
});
...
<svg xmlns="${"http://www.w3.org/2000/svg"}" width="${"100%"}" height="${"100%"}" viewBox="${"0 0 1110.000000 1280.000000"}" preserveAspectRatio="${"xMidYMin meet"}"><metadata>Created by potrace 1.15, written by Peter Selinger 2001-2017
    </metadata><g transform="${"translate(0.000000,1280.000000) scale(0.100000,-0.100000)"}"${add_attribute("fill-opacity", opacity, 0)}>${validate_component(PathInteractive, "PathInteractive").$$render(
    $$result,
    {
...
class Europe {
  ...
  CS = { key: "CS", id: "czechoslovakia", color: "#00008b", de: "Tschechoslowakei", en: "Czechoslovakia" };
...
const HeatMapSettings = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let initialButtonStyle = "text-md font-bold border border-amber-500 dark:border-none rounded bg-amber-400 dark:bg-firebrick-800 h-8";
  let activatedButtonStyle = "text-lg font-bold ring-2 ring-amber-500 rounded dark:bg-firebrick-700 dark:ring-firebrick-600 bg-amber-400 dark:bg-firebrick-800 h-8";
  ...
  return `<div${add_attribute("class", className, 0)}>
    ...
    {}
        ...
        <button class="${"col-span-3 w-full " + escape(currentButtonStyles.unknown, true)}">${validate_component(T, "T").$$render($$result, { en: "unknown", de: "unbekannt" }, {}, {})}</button>
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let heatMapColors = [];
  let mapUpperBound = 0;
  let countryAmount = { countryDE: "", countryEN: "", amount: 0 };
  ...
  function calculatePersonsPerLocation(country) {
  ...
  function calculateMaximumExcludingGermany(json) {
    mapUpperBound = 0;
    for (const yearEntry in json) {
      let amountPerYear = 0;
      for (const gender of getChosenGenders()) {
...
<div class="${"grid grid-cols-1 grow md:grid-cols-3"}">
    <div class="${"relative w-full md:col-span-2"}">
      ...
      $$result,
      {
        de: "Ein maximal eingefärbtes Land entspricht " + mapUpperBound + " Personen.",
      ...
      $$result,
      {
        de: "In " + countryAmount.countryDE + " waren " + countryAmount.amount + " Personen beschäftigt.",
    ...
    <div class="${"md:border-l p-2 border-firebrick-500 dark:border-firebrick-1000 h-full"}">Detaillierte Informationen:
    </div></div>`;
  } while (!$$settled);
...
//# sourceMappingURL=_page.svelte-57637bd6.js.map
