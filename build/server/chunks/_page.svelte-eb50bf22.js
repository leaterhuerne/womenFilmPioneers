import { c as create_ssr_component, a as subscribe, v as validate_component, e as escape, b as each, d as add_attribute } from './index3-11153cb5.js';
...
<div class="${escape(responsive, true) + ":w-min"}">
    ...
    {}
        ...
        <div class="${escape(className, true) + " border border-black dark:border-warm-gray-600 bg-dark-paper-200 dark:bg-warm-gray-700 p-0.5 w-min rounded"}"><div class="flex">
                <div class="bg-inherit w-20 grid place-items-center font-bold text-center text-xl">${escape(year)}</div>
...
const HeatMapSettings = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let { maxPerYear = ALL_YEARS } = $$props;
  ...
  let chevronButtonStyle = "rounded-[50%] bg-amber-300 dark:bg-firebrick-900 hover:bg-amber-400 hover:dark:bg-firebrick-800 dark:hover:border border-firebrick-700";
  let initialButtonStyle = "text-sm sm:text-md font-bold border border-amber-400 dark:border-none rounded bg-amber-300 dark:bg-firebrick-900 h-8";
  ...
  if ($$props.maxPerYear === void 0 && $$bindings.maxPerYear && maxPerYear !== void 0)
    $$bindings.maxPerYear(maxPerYear);
  ...
  return `<div${add_attribute("class", className, 0)}>
    <div class="grid grid-cols-9 place-items-center gap-2">
        <div class="hidden col-span-9 grid grid-cols-2 gap-2 w-full border-blue-500"><button class="${"w-full " + escape(currentButtonStyles.absolute, true)}">${validate_component(T, "T").$$render(
    $$result,
    {
    ...
    {}
        ...
        <h1 class="col-span-5 w-full rounded text-md text-center bg-amber-300 dark:bg-firebrick-900 ">${profession === "" ? `${validate_component(T, "T").$$render($$result, { en: "all", de: "alle" }, {}, {})}` : `${escape(profession)}`}</h1>
        
        <button class="${"rounded-[50%] duration-500 " + escape(informationButtonStyle, true)}">${validate_component(Cog, "Cog").$$render($$result, { darkColor: "#D2CAB3" }, {}, {})}</button>
...
<div${add_attribute("class", className, 0)}>
    ...
    <div class="mt-4 flex place-items-center"><h2 class="text-xl font-semibold">${validate_component(T, "T").$$render(
    $$result,
    {
    ...
    return `<div class="">
            <h3 class="mt-2 text-md font-semibold text-firebrick-700 dark:text-firebrick-500">${escape(filmData[film].title)}</h3>
            
            <ul class="">${each(filmData[film]["people"], (person, personIndex) => {
      return `${personIndex < filmData[film]["people"].length - 1 ? `<li class="grid grid-cols-2 gap-2 border-b border-warm-gray-700 dark:border-warm-gray-800 py-2"><span>${escape(person.name)}</span>
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  const colorPickerNamesDE = ["Wenige Daten", "Viele Daten"];
  const colorPickerNamesEN = ["Few data", "A lot of data"];
  let currentLanguage;
...
<div class="grid grid-cols-1 grow md:grid-cols-3">
    <div class="relative w-full md:col-span-2">
        <div class="grid place-items-center">${validate_component(HeatMap, "HeatMap").$$render(
      $$result,
      {
      ...
      $$result,
      {
        className: "bg-amber-300 dark:bg-firebrick-900",
        year
      },
      {
        year: ($$value) => {
      ...
      $$result,
      {
        de: "Ein maximal eingefärbtes Land repräsentiert " + mapUpperBound + " Personen, die an in der Datenbank\r\n                        des DFF erfassten Filmen in dem ausgewählten Jahr beteiligt waren.",
      ...
      $$result,
      {
        de: "Gestreifte Flächen zeigen an, dass das DFF keine Daten für das jeweilige Land im ausgewählten\r\n                        Jahr vorhält. Dies bedeutet nicht, dass in dem Land in diesem Zeitraum keine Filme gedreht\r\n                        worden sind.",
    ...
    <div class="border-t-2 md:border-l md:border-t-0 border-firebrick-500 dark:border-firebrick-1000 p-2 h-full">${validate_component(SidePanel, "SidePanel").$$render(
      $$result,
      {
        data,
        year,
...
//# sourceMappingURL=_page.svelte-eb50bf22.js.map
